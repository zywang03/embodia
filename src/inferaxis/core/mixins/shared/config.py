"""Private config-validation helpers shared by inferaxis mixins."""
...
def normalize_modality_name(key: ModalityToken | str) -> str:
    ...
    if isinstance(key, ModalityToken):
        ...
        raise InterfaceValidationError(
            "modality_maps keys must be strings or inferaxis modality tokens, "
...
def configure_runtime_interface(
    ...
    *,
    ...
    if modality_maps is not None:
        setattr(owner, "_inferaxis_modality_maps", copy_modality_maps(modality_maps))
