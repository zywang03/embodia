"""Latency and raw/control-step projection helpers for chunk scheduling."""
...
class ChunkSchedulerLatencyOpsMixin:
    """Helpers that track latency and raw/control-step projections."""
    ...
    def _project_control_latency_to_raw_steps(
        ...
        *,
        ...
        if buffer_actions is None:
            active_buffer = list(self._buffer)
        else:
            active_buffer = list(buffer_actions)
