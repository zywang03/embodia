...
class ChunkSchedulerRequestOpsMixin:
    """Helpers that build requests and track trigger timing."""
    ...
    def _execute_request(
        ...
        if self.use_overlap_blend and job.launch_buffer:
            ...
            prepared_actions = fused + plan[overlap_count:]
        else:
            prepared_actions = self._clone_actions(plan)
