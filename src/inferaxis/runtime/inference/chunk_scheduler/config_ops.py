"""Configuration validation and latency-mode helpers for chunk scheduling."""
...
class ChunkSchedulerConfigOpsMixin:
    """Helpers that validate configuration and expose latency state."""
