...
class ChunkRequest:
    ...
    ``history_actions`` contains the tail slice from the currently active chunk
    that the next chunk should condition on. ``request_step`` is the global
    action index that had already been emitted when the request was sent.
    """
