"""Helpers for loading inferaxis config from optional YAML files."""
...
def require_yaml() -> None:
    ...
    if not is_yaml_available():
        raise InterfaceValidationError(
            ...
            "Install it with `pip install 'inferaxis[yaml]'`."
        )
...
def load_yaml_config(
    ...
    *,
    ...
    """Load one inferaxis config mapping from a YAML file."""
...
def load_component_yaml_config(
    ...
    *,
    ...
    """Load config for one inferaxis component from a YAML file."""
